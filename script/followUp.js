function generateMessage() {
  ...
  const message = `
    <p>Hi ${name},</p><br>
    <p class="btm-mrg">The quote of <span class="highlight">$${price}</span> for <a href="${vehicleInfo.vehicleLink}" class="highlight vehicleName" target="_blank">${vehicleInfo.vehicleName}</a>  is <strong>expiring soon.</strong> Please make your reservation online and get <strong>5% OFF.</strong> Coupon Code: WTGONL5</p>
